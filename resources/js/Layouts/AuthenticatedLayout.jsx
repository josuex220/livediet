        ...
        <div className="min-h-screen bg-gray-100">
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div className="mt-3 space-y-1">
                            <ResponsiveNavLink href={route('profile.edit')}>Minha Conta</ResponsiveNavLink>
            ...
            <footer className="bg-white dark:bg-gray-900" style={{marginTop:'auto'}}>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://www.livediet.com.br/" className="hover:underline">Live Diet</a>. Todos os direitos reservados.
                    </span>
